...
class H2SDataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        if cfg.TRAIN.STAGE in ["vae"]:
        ...
        elif cfg.TRAIN.STAGE == "lm_rvq_hierarchical":
            # Hierarchical RVQ-GPT: uses token dataset (no instruction files)
            ...
            # Keep DatasetEval as Text2MotionDatasetEval (returns raw poses for testing)
